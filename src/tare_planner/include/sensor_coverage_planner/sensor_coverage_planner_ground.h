...
struct PlannerParameters
{
  ...
  bool kCheckTerrainCollision;//区域碰撞检测
  ...
  // Double
  double kKeyposeCloudDwzFilterLeafSize; //对点云降采样时，设置的体素大小
  double kRushHomeDist;
  double kAtHomeDistThreshold;
  double kTerrainCollisionThreshold; // 地形碰撞阈值
